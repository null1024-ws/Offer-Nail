...
4. 教育经历里的「研究方向：xxx」→ researchDirection；「主要课程：xxx」→ courses（多个用中文分号「；」分隔）；「GPA：84.04/100」→ gpa=84.04 且 gpaScale=100；「专业排名：27/94」→ rank。
...
11. 值尽量保留原文，不要翻译或改写；邮箱、电话、链接、英文术语保持不变。
